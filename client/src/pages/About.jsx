...
const About = () => {
    return (
        <div className="relative min-h-[calc(100vh-72px)] flex flex-col items-center py-16 md:py-24 px-4 overflow-hidden bg-(--bg-main) transition-colors">
            {/* Background Glows */}
            ...
            <div className="max-w-5xl w-full space-y-16 animate-in fade-in slide-in-from-bottom duration-1000">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12">
                    ...
                    <div className="glass-card p-8! space-y-4 hover:border-blue-500/30 transition-all duration-300 group">
                        ...
                        <p className="text-slate-500 font-medium text-sm leading-relaxed">
                            Your data and your career journey are with industry-leading security.
                        </p>
                    </div>
                </div>
