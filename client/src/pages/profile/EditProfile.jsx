    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
            ...
            <div className="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl flex flex-col max-h-[90vh] border border-slate-200 animate-in zoom-in duration-300">
                ...
                <div className="flex items-center justify-between p-4 border-b border-slate-100 bg-white rounded-t-2xl transition-colors">
                    <div>
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto flex flex-col">
                    ...
                    {/* Footer */}
                    <div className="p-6 border-t border-slate-100 bg-slate-50/50 rounded-b-3xl transition-colors">
