...
const ProfilePage = () => {
    ...
    const handleProfilePicUpload = async (e) => {
        ...
        try {
            ...
            setProfile((prev) => ({ ...prev, profilePicture: data.filePath }));
    ...
    const handleResumeUpload = async (e) => {
        ...
        if (file.type !== "application/pdf") {
            setResumeError("Upload Rejected a PDF file but received another format.");
        ...
        try {
            ...
            setProfile((prev) => ({ ...prev, resume: data.filePath }));
