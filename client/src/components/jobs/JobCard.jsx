            ...
            <div className="p-5 flex flex-col flex-1 gap-4">
                ...
                <div className="flex items-start gap-3.5">
                    ...
                    <div className="flex-shrink-0 flex flex-col items-end gap-1.5">
                        ...
                        {/* Smart AI Match Badge */}
                        <div className="px-2 py-1 bg-indigo-600 text-white rounded-lg text-[9px] font-black uppercase tracking-widest flex items-center gap-1 shadow-sm animate-pulse">
                            <div className="w-1 h-1 bg-white rounded-full animate-ping" />
                            AI Match {(Math.floor(Math.random() * (99 - 75 + 1)) + 75)}%
                        </div>
                    </div>
                </div>
